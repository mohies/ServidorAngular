...
from .models import UsuarioLogin, Organizador, Usuario, PerfilDeJugador, Equipo, Participante, Torneo, Jugador, Consola, Juego, Espectador, Clasificacion, ParticipanteEquipo, TorneoJuego, TorneoParticipante, TorneoJugador,Favorite
...
class FavoriteSerializer(serializers.ModelSerializer):
    user = serializers.PrimaryKeyRelatedField(queryset=UsuarioLogin.objects.all(), required=False)

    class Meta:
        model = Favorite
        fields = ['id', 'user', 'item_id', 'item_name', 'created_at']
