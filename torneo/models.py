...
class Favorite(models.Model):
    user = models.ForeignKey(UsuarioLogin, on_delete=models.CASCADE)  # Relación con UsuarioLogin
    item_id = models.IntegerField()  # ID del juego favorito
    item_name = models.CharField(max_length=255)  # Nombre del juego favorito
